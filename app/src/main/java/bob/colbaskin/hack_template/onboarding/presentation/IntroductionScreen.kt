...
import bob.colbaskin.hack_template.R
import bob.colbaskin.hack_template.common.design_system.Lottie
import bob.colbaskin.hack_template.common.design_system.PagerWithIndicator
...
private sealed class OnBoardingPage(
    ...
    data object First: OnBoardingPage(lottieJson = R.raw.first)
    data object Second: OnBoardingPage(lottieJson = R.raw.second)
    data object Third: OnBoardingPage(lottieJson = R.raw.third)
