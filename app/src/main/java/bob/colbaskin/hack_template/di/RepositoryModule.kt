package bob.colbaskin.hack_template.di

import bob.colbaskin.hack_template.auth.data.AuthRepositoryImpl
import bob.colbaskin.hack_template.auth.data.RefreshTokenRepositoryImpl
