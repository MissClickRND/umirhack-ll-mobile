...
sealed interface ProfileAction {
    ...
    data object RefreshAll: ProfileAction
    ...
    data class PagerPageChanged(val page: Int): ProfileAction

    data class OpenShareSheet(val diplomaId: Long): ProfileAction
    ...
    data class RevokeLink(val tokenId: Long): ProfileAction

    data class UpdateAttachDiplomaId(val text: String): ProfileAction
    data object AttachDiplomaToMe: ProfileAction
}
